...
export const WalletButton = () => {
  ...
  return <div className="relative">
      <WalletMultiButton className="!bg-gradient-to-r !from-accent !to-primary hover:!opacity-90 !h-9 !px-4 !transition-all !shadow-lg hover:!shadow-xl !border-0 !rounded-lg !text-sm !font-bold mx-[15px]" />
