...
export const WalletButton = () => {
  ...
  return <div className="relative">
      <WalletMultiButton className="!bg-gradient-to-r !from-primary !to-secondary hover:!opacity-90 !h-7 !px-3 !transition-all !shadow-lg hover:!shadow-xl !border-0 rounded-lg text-xs font-bold text-center" />
